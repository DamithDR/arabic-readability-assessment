...
def get_data_frames(file_path='data/readability/DARES1.0/fine-grained', mode='default', append_column=None):
...
def run(args):
    ...
    # Fine-grained experiments (G1-G12)
        ...
        train_df, test_df, validation_df = get_data_frames(file_path='data/readability/DARES1.0/fine-grained')
    ...
    # Coarse-grained experiments (EE/UE/INT/HS)
        ...
        train_df, test_df, validation_df = get_data_frames(file_path='data/readability/DARES1.0/coarse-grained')
    elif args.run_mode == "categorised_test":
        train_df, test_df, validation_df = get_data_frames(file_path='data/readability/DARES1.0/coarse-grained', mode='test')
